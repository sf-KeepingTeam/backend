...
public final class MenuFixtures {
  ...
  public static Menu menu(
      Store store, MenuCategory category, String menuName, int price, int displayOrder) {
    return Menu.builder()
        .store(store)
        .category(category)
        .menuName(menuName)
  ...
  public static Menu menuWithDescription(
      Store store, MenuCategory category, String menuName, int price, String description) {
    return Menu.builder()
        .store(store)
        .category(category)
        .menuName(menuName)
  ...
  public static Menu inactiveMenu(
      Store store, MenuCategory category, String menuName, int price, int displayOrder) {
    return Menu.builder()
        .store(store)
        .category(category)
  ...
  public static Menu soldOutMenu(
      Store store, MenuCategory category, String menuName, int price, int displayOrder) {
    return Menu.builder()
        .store(store)
        .category(category)
