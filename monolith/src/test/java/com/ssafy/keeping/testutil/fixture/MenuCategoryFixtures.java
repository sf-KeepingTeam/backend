...
public final class MenuCategoryFixtures {
  ...
  public static MenuCategory category(Store store, String categoryName) {
    return MenuCategory.builder().store(store).categoryName(categoryName).displayOrder(0).build();
  }
  ...
  public static MenuCategory subCategory(
      Store store, MenuCategory parent, String categoryName, int displayOrder) {
    return MenuCategory.builder()
        .store(store)
        .parent(parent)
        .categoryName(categoryName)
