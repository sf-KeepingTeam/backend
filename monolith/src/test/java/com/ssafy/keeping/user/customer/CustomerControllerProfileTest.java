...
public class CustomerControllerProfileTest extends MySqlTestContainerConfig {
  ...
  void getMyProfile_success() throws Exception {
    ...
    mockMvc
        .perform(
            get("/customers/me").with(SecurityMockMvcRequestPostProcessors.authentication(auth)))
  ...
  void myGroups_unauthorized() throws Exception {
    ...
    // when & then
    mockMvc.perform(get("/customers/me/groups")).andExpect(status().isUnauthorized());
  }
}
