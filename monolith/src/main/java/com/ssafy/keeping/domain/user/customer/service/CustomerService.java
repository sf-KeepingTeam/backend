...
public class CustomerService {
  ...
  public Optional<Customer> findByProviderTypeAndProviderId(
      AuthProvider providerType, String providerId) {
    return customerRepository.findByProviderTypeAndProviderIdAndDeletedAtIsNull(
  ...
  public ProfileUploadResponse uploadProfileImage(Long customerId, MultipartFile newImage) {
    String oldImgUrl =
        customerRepository
            .findImageUrlByCustomerId(customerId)
    ...
    try {
      ...
      return ProfileUploadResponse.builder().newImgUrl(newImgUrl).build();
