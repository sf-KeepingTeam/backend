...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
  ...
  // 소셜 타입과 id 로 조회
  Optional<Customer> findByProviderTypeAndProviderIdAndDeletedAtIsNull(
  ...
  @Query(
      "UPDATE Customer c SET c.name = :name, c.phoneNumber = :phoneNumber WHERE c.customerId = :customerId")
