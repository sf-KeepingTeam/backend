...
public class ChargeBonusController {
  ...
  public ResponseEntity<ApiResponse<ChargeBonusResponseDto>> createChargeBonus(
    ...
    ChargeBonusResponseDto responseDto =
        chargeBonusService.createChargeBonus(ownerId, storeId, requestDto);
  ...
  public ResponseEntity<ApiResponse<List<ChargeBonusListResponseDto>>> getChargeBonusList(
    ...
    List<ChargeBonusListResponseDto> responseDtoList =
        chargeBonusService.getChargeBonusList(ownerId, storeId);

    return ResponseEntity.ok()
        .body(
            ApiResponse.success("충전 보너스 설정 목록이 조회되었습니다.", HttpStatus.OK.value(), responseDtoList));
  }
  ...
  public ResponseEntity<ApiResponse<ChargeBonusResponseDto>> getChargeBonus(
    ...
    log.info(
        "충전 보너스 설정 상세 조회 요청 수신 - 점주ID: {}, 가게ID: {}, 보너스ID: {}", ownerId, storeId, chargeBonusId);

    ChargeBonusResponseDto responseDto =
        chargeBonusService.getChargeBonus(ownerId, storeId, chargeBonusId);
  ...
  public ResponseEntity<ApiResponse<ChargeBonusResponseDto>> updateChargeBonus(
    ...
    ChargeBonusResponseDto responseDto =
        chargeBonusService.updateChargeBonus(ownerId, storeId, chargeBonusId, requestDto);
