...
/**
 * 전액 결제 취소(가맹점용) - URL: POST /stores/{storeId}/transactions/{transactionId}/refund - 정책: 항상 FULL
 * CANCEL - 멱등: Idempotency-Key 헤더 필수 - 결과: transactions에 CANCEL_USE 생성, balances/lot 복원
 */
@RestController
