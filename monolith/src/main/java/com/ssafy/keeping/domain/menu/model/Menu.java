...
@Table(
    ...
    uniqueConstraints = {
      @UniqueConstraint(
          name = "uq_order_per_category",
          columnNames = {"store_id", "category_id", "display_order"})
    },
    indexes = {
...
public class Menu {
  ...
  public void editMenu(String menuName, String imgUrl, int price, String description, int order) {
