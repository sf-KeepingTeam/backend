...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
  ...
  @Query(
      """
        ...
        """)
  Page<Transaction> findValidTransactionsByCustomerAndStore(
      @Param("customerId") Long customerId, @Param("storeId") Long storeId, Pageable pageable);
  ...
  @Query(
      """
        ...
        ORDER BY t.createdAt DESC
        """)
  Page<Transaction> findValidTransactionsByGroupAndStore(
      @Param("groupId") Long groupId, @Param("storeId") Long storeId, Pageable pageable);

  // ============== 통계용 쿼리 메서드들 ==============

  /** 가게별 전체 누적 실제 결제금액 (SettlementTask 기준) */
  @Query(
      "SELECT COALESCE(SUM(st.actualPaymentAmount), 0) "
  ...
  /** 가게별 전체 거래 건수 */
  @Query("SELECT COUNT(t) " + "FROM Transaction t " + "WHERE t.store.storeId = :storeId")
  ...
  @Query(
      "SELECT COALESCE(SUM(t.amount), 0) "
          ...
          + "AND t.transactionType = 'CHARGE' "
          + "AND DATE(t.createdAt) = :date")
  Long getDailyTotalChargePointsByStore(
  ...
  @Query(
      "SELECT COUNT(t) "
          ...
          + "WHERE t.store.storeId = :storeId "
          + "AND DATE(t.createdAt) = :date")
  Long getDailyTransactionCountByStore(
      @Param("storeId") Long storeId, @Param("date") LocalDate date);
  ...
  Long getPeriodPaymentAmountByStore(
  ...
  @Query(
      "SELECT COALESCE(SUM(t.amount), 0) "
          ...
          + "AND t.transactionType = 'CHARGE' "
          + "AND DATE(t.createdAt) BETWEEN :startDate AND :endDate")
  Long getPeriodTotalChargePointsByStore(
      @Param("storeId") Long storeId,
      @Param("startDate") LocalDate startDate,
      @Param("endDate") LocalDate endDate);
  ...
  @Query(
      "SELECT COALESCE(SUM(t.amount), 0) "
          ...
          + "AND t.transactionType = 'USE' "
          + "AND DATE(t.createdAt) BETWEEN :startDate AND :endDate")
  Long getPeriodPointsUsedByStore(
      @Param("storeId") Long storeId,
      @Param("startDate") LocalDate startDate,
      @Param("endDate") LocalDate endDate);
  ...
  @Query(
      "SELECT COUNT(t) "
          ...
          + "AND t.transactionType = 'CHARGE' "
          + "AND DATE(t.createdAt) BETWEEN :startDate AND :endDate")
  Long getPeriodChargeCountByStore(
      @Param("storeId") Long storeId,
      @Param("startDate") LocalDate startDate,
      @Param("endDate") LocalDate endDate);
  ...
  @Query(
      "SELECT COUNT(t) "
          ...
          + "WHERE t.store.storeId = :storeId "
          + "AND DATE(t.createdAt) BETWEEN :startDate AND :endDate")
  Long getPeriodTransactionCountByStore(
      @Param("storeId") Long storeId,
      @Param("startDate") LocalDate startDate,
      @Param("endDate") LocalDate endDate);
  ...
  Long getMonthlyPaymentAmountByStore(
      @Param("storeId") Long storeId, @Param("year") int year, @Param("month") int month);
  ...
  @Query(
      "SELECT COALESCE(SUM(t.amount), 0) "
          ...
          + "AND YEAR(t.createdAt) = :year "
          + "AND MONTH(t.createdAt) = :month")
  Long getMonthlyTotalChargePointsByStore(
      @Param("storeId") Long storeId, @Param("year") int year, @Param("month") int month);
  ...
  @Query(
      "SELECT COALESCE(SUM(t.amount), 0) "
          ...
          + "AND YEAR(t.createdAt) = :year "
          + "AND MONTH(t.createdAt) = :month")
  Long getMonthlyPointsUsedByStore(
      @Param("storeId") Long storeId, @Param("year") int year, @Param("month") int month);
  ...
  @Query(
      "SELECT COUNT(t) "
          ...
          + "AND YEAR(t.createdAt) = :year "
          + "AND MONTH(t.createdAt) = :month")
  Long getMonthlyChargeCountByStore(
      @Param("storeId") Long storeId, @Param("year") int year, @Param("month") int month);
  ...
  @Query(
      "SELECT COUNT(t) "
          ...
          + "AND YEAR(t.createdAt) = :year "
          + "AND MONTH(t.createdAt) = :month")
  Long getMonthlyUseCountByStore(
      @Param("storeId") Long storeId, @Param("year") int year, @Param("month") int month);
  ...
  @Query(
      "SELECT COUNT(t) "
          ...
          + "AND YEAR(t.createdAt) = :year "
          + "AND MONTH(t.createdAt) = :month")
  Long getMonthlyTransactionCountByStore(
      @Param("storeId") Long storeId, @Param("year") int year, @Param("month") int month);

  /**
   * PK로 조회 + 쓰기 락 (SELECT ... FOR UPDATE) - 동시성 하에서 동일 TX를 중복 취소/변경하지 않도록 보호!!! - 락 타임아웃은 상황에 맞게
   * 조절(아래 5초 예시)
   */
  ...
  @Query(
    ...
    """)
  boolean existsByRefTxIdAndType(
      @Param("refTxId") Long refTxId, @Param("type") TransactionType type);
  ...
  @Query(
      """
        ...
        where t.refTransaction.transactionId = :refTxId
          and t.transactionType = :type
    """)
  Optional<Transaction> findCancelByRef(
      @Param("refTxId") Long refTxId, @Param("type") TransactionType type);
}
