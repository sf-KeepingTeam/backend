...
public class AuthController {
  ...
  /** Nginx auth_request용 JWT 검증 엔드포인트 - 성공 시: 200 + 사용자 정보 헤더 - 실패 시: 401 */
  @GetMapping("/verify")
  ...
  public ResponseEntity<ApiResponse<TokenRefreshResponse>> refresh(
    ...
    String accessToken =
        accessTokenService.issueAccessToken(String.valueOf(payload.userId()), payload.role());

    TokenRefreshResponse body =
        TokenRefreshResponse.of(
            payload.role().name(), accessToken, accessTokenService.accessTtlSeconds());
