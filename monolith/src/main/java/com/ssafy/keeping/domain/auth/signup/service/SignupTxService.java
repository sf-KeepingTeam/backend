...
public class SignupTxService {
  ...
  public SignupResult signupCustomerTx(CustomerSignupRequest req) {
    ...
    var existing =
        customerService.findByProviderTypeAndProviderId(
            payload.providerType(), payload.providerId());
  ...
  public SignupResult signupOwnerTx(OwnerSignupRequest req) {
    ...
    var existing =
        ownerService.findByProviderTypeAndProviderId(payload.providerType(), payload.providerId());
    if (existing.isPresent()) {
