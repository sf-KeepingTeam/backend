...
public class OwnerStoreController {
  ...
  public ResponseEntity<ApiResponse<StoreResponseDto>> createStore(
    ...
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(ApiResponse.success("매장이 등록되었습니다", HttpStatus.CREATED.value(), dto));
  }
  ...
  public ResponseEntity<ApiResponse<StoreResponseDto>> deleteStore(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "매장이 삭제되었습니다", HttpStatus.OK.value(), storeService.deleteStore(storeId, ownerId)));
  }
  ...
  public ResponseEntity<ApiResponse<List<StoreResponseDto>>> getMyStores(
    ...
    return ResponseEntity.ok(
        ApiResponse.success("내 매장 목록이 조회되었습니다.", HttpStatus.OK.value(), stores));
  }
