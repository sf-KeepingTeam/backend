...
/**
 * 결제 게이트웨이 팩토리 설정에 따라 적절한 결제 제공자를 반환
 *
 * <p>사용법: 1. 기본 제공자 사용: paymentGatewayFactory.getDefaultGateway() 2. 특정 제공자 사용:
 * paymentGatewayFactory.getGateway(PaymentProvider.TOSS)
 */
@Slf4j
@Component
public class PaymentGatewayFactory {
  ...
  public PaymentGatewayFactory(
    ...
    log.info(
        "[PaymentGatewayFactory] 초기화 완료 - 등록된 게이트웨이: {}, 기본 제공자: {}",
        gateways.keySet(),
        defaultProvider);
  }

  /** 기본 결제 게이트웨이 반환 application.yml의 payment.provider 설정 사용 */
