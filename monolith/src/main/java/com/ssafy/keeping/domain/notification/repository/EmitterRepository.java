...
public class EmitterRepository {
   ...
   */
  public Map<String, SseEmitter> findAllEmitterStartWithByReceiver(
   ...
   */
  public Map<String, Object> findAllEventCacheStartWithByReceiver(
      String receiverType, Long receiverId) {
    String prefix = receiverType + "-" + receiverId;
  ...
  public boolean hasActiveConnection(String receiverType, Long receiverId) {
    ...
    String prefix = receiverType + "-" + receiverId;
    return emitters.entrySet().stream().anyMatch(entry -> entry.getKey().startsWith(prefix));
  }
}
