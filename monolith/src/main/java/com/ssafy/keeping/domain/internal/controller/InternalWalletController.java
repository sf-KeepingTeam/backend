...
public class InternalWalletController {
  ...
  /** 자금 캡처 (결제 시 잔액 차감 + 거래 내역 생성) Idempotency-Key 헤더를 통해 중복 결제 방지 */
  ...
  public ResponseEntity<?> capture(
    ...
    IdempotentResult<FundsResponse> result =
        internalWalletService.captureIdempotent(request, idempotencyKey);
  ...
  public ResponseEntity<?> refund(
    ...
    IdempotentResult<RefundResponse> result =
        internalWalletService.processRefundIdempotent(walletId, request, idempotencyKey);
