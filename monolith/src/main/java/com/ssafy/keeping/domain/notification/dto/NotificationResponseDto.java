...
public class NotificationResponseDto {
  ...
  public static NotificationResponseDto from(Notification notification) {
    return NotificationResponseDto.builder()
        ...
        .createdAt(
            notification.getCreatedAt().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")))
        .build();
  }

  // SSE 이벤트용 간단한 생성자
  public static NotificationResponseDto forSSE(
      String content, NotificationType type, String receiverType, Long receiverId) {
    return NotificationResponseDto.builder()
        .content(content)
        .isRead(false)
