...
public class MenuService {
  ...
  public MenuResponseDto editMenu(
      Long ownerId, Long storeId, Long menuId, MenuEditRequestDto requestDto) {
    Owner owner = validOwner(ownerId);
    Store store = validStore(storeId);
    ...
    int order =
        changed
            ? menuRepository.nextOrderIncludingDeleted(storeId, requestDto.getCategoryId())
  ...
  private Menu validMenu(Long menuId, Long storeId) {
    return menuRepository
        .findByMenuIdAndStore_StoreId(menuId, storeId)
