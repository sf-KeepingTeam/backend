...
public class StoreStatisticsController {
  ...
  public ResponseEntity<ApiResponse<StoreOverallStatisticsResponseDto>> getOverallStatistics(
      @PathVariable Long storeId, @AuthenticationPrincipal UserPrincipal principal) {
    Long ownerId = principal.id();

    log.info("전체 통계 조회 요청 - 가게ID: {}, 점주ID: {}", storeId, ownerId);

    StoreOverallStatisticsResponseDto responseDto =
        storeStatisticsService.getOverallStatistics(storeId, ownerId);
  ...
  public ResponseEntity<ApiResponse<DailyStatisticsResponseDto>> getDailyStatistics(
    ...
    log.info("일별 통계 조회 요청 - 가게ID: {}, 점주ID: {}, 날짜: {}", storeId, ownerId, requestDto.getDate());

    DailyStatisticsResponseDto responseDto =
        storeStatisticsService.getDailyStatistics(storeId, ownerId, requestDto);
  ...
  public ResponseEntity<ApiResponse<PeriodStatisticsResponseDto>> getPeriodStatistics(
    ...
    log.info(
        "기간별 통계 조회 요청 - 가게ID: {}, 점주ID: {}, 기간: {} ~ {}",
        storeId,
        ownerId,
        requestDto.getStartDate(),
        requestDto.getEndDate());

    PeriodStatisticsResponseDto responseDto =
        storeStatisticsService.getPeriodStatistics(storeId, ownerId, requestDto);
  ...
  public ResponseEntity<ApiResponse<MonthlyStatisticsResponseDto>> getMonthlyStatistics(
    ...
    log.info("월별 통계 조회 요청 - 가게ID: {}, 점주ID: {}, 날짜: {}", storeId, ownerId, requestDto.getDate());

    MonthlyStatisticsResponseDto responseDto =
        storeStatisticsService.getMonthlyStatistics(storeId, ownerId, requestDto);
