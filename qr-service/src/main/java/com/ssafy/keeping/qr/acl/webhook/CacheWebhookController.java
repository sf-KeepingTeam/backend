 ...
 * X-Cache-Version 헤더로 단조 version 비교 — 재정렬·중복 방어
 */
@Slf4j
@RestController
...
public class CacheWebhookController {
    ...
    /**
     * Store 캐시 갱신/삭제
     * - body가 있으면: version 비교 후 캐시 갱신
     * - body가 없으면: version 비교 후 캐시 삭제 (tombstone 유지)
     */
    ...
    public ResponseEntity<Void> updateStoreCache(
            ...
            @RequestHeader(value = HttpHeaderConstants.X_CACHE_VERSION, required = false, defaultValue = "0") long version,
