...
public class QrTokenService {
  ...
  /** QR 스캔 및 세션 토큰 발급 1. GETDEL로 QR 토큰 원자적 소비 (조회 + 삭제 단일 커맨드) 2. 세션 토큰 발급 (3분 TTL) */
  public QrScanResponse scanAndConsumeQr(String tokenId) {
    ...
    log.info(
        "세션 토큰 발급: sessionToken={}, customerId={}, walletId={}, ttl={}초",
        sessionToken,
  ...
  public void deleteSession(String sessionToken) {
    scanSessionRepository.findBySessionToken(sessionToken).ifPresent(scanSessionRepository::delete);
