...
@Table(
    ...
    indexes = {@Index(name = "idx_idem_created", columnList = "created_at")})
public class IdempotencyKey {
  ...
  // NOTE: prod 배포 시 ALTER TABLE idempotency_keys ADD COLUMN updated_at DATETIME(3) NOT NULL DEFAULT
  // CURRENT_TIMESTAMP(3);
